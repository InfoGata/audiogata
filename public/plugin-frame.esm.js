    ...
    var newFunc = function newFunc() {
      ...
      return new Promise(function (resolve, reject) {
        ...
        if (_this3.options.prepareFuncs && _this3.options.prepareFuncs[name]) {
          args = _this3.options.prepareFuncs[name].apply(null, args);
        }
...
var PluginHost = /*#__PURE__*/function (_Connection) {
  _inheritsLoose(PluginHost, _Connection);
